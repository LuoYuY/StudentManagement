...
<nav class="navbar nav_bottom" role="navigation">
 <div class="container">
	...
	<form action="${pageContext.request.contextPath}/updateStudent.do?init=false" method="post">
       <div class="container">
		 <div class="col-sm-10 dropdown-buttons">   
			<div class="col-sm-3 dropdown-button">           			
    		  <div class="input-group">
				
                <input class="form-control has-dark-background"   readonly="readonly" value="${student.luoyy_sno}" name="luoyy_sno" id="luoyy_sno" placeholder="学号" type="text" required="">
              </div>
			</div>
			<div class="col-sm-3 dropdown-button">           			
    		  <div class="input-group">
                <input class="form-control has-dark-background" value="${student.luoyy_sname}" name="luoyy_sname" id="luoyy_sname" placeholder="姓名" type="text" required="">
              </div>
			</div>
    	   <div class="col-sm-3 dropdown-button">           			
    		  <div class="input-group">
				 <input class="form-control has-dark-background" name="luoyy_ssex" id="luoyy_ssex" value="${student.luoyy_ssex}" placeholder="性别" type="text" required="">
              </div>
			</div>
		     <div class="col-sm-3 dropdown-button">
			  <div class="input-group">
			 
				<input class="form-control has-dark-background" value="${student.luoyy_sbirthday}"  name="luoyy_sbirthday" id="luoyy_sbirthday" placeholder="生日" type="text" required="">
              </div>
			 </div>
			 <div class="clearfix"> </div>
		  </div> 
		 ...
		 <div class="col-sm-10 dropdown-buttons">   
			<div class="col-sm-3 dropdown-button">           			
    		  <div class="input-group">
                <input class="form-control has-dark-background" value="${student.luoyy_birthplace}" name="luoyy_birthplace" id="luoyy_birthplace" placeholder="籍贯" type="text" required="">
              </div>
			</div>
			<div class="col-sm-3 dropdown-button">           			
    		  <div class="input-group">
                <input class="form-control has-dark-background"  value="${student.luoyy_scredit}" name="luoyy_scredit" id="luoyy_scredit" placeholder="已修学分" type="text" required="">
              </div>
			</div>
    	   <div class="col-sm-3 dropdown-button">           			
    		 <div class="input-group">
                <input class="form-control has-dark-background" value="${student.luoyy_mno}" name="luoyy_mno" id="luoyy_mno" placeholder="专业号" type="text" required="">
              </div>
			</div>
		     <div class="col-sm-3 dropdown-button">
			  <div class="input-group">
                <input class="form-control has-dark-background" value="${student.luoyy_classno}" name="luoyy_classno" id="luoyy_classno" placeholder="班级号" type="text" required="">
              </div>
			 </div>
			 <div class="clearfix"> </div>
		  </div> 
		  <div class="col-sm-2 submit_button"> 
				...
				<input type="submit" name="addBtn" id="addBtn" value="修改">
