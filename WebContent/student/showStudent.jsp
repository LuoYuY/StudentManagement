  ...
  <div class="courses_banner">
	...
	<div class="admission">
	   <div class="container">
	   	    <dl class="faq-list">
				<dt class="faq-list_h">
				<h4 class="marker">学号</h4>
				<h4><span style="color:white">hahahahaha</span>${student.luoyy_sno}</h4>
				</dt>
				
				<dt class="faq-list_h">
				<h4 class="marker">姓名</h4>
				<h4><span style="color:white">hahahahaha</span>${student.luoyy_sname}</h4>
				</dt>
				
				<dt class="faq-list_h">
				<h4 class="marker">性别</h4>
				<h4><span style="color:white">hahahahaha</span>${student.luoyy_ssex}</h4>
				</dt>
				
				<dt class="faq-list_h">
				<h4 class="marker">生日</h4>
				<h4><span style="color:white">hahahahaha</span>${student.luoyy_sbirthday}</h4>
				</dt>
				
				<dt class="faq-list_h">
				<h4 class="marker">籍贯</h4>
				
				<h4><span style="color:white">hahahahaha</span>${student.luoyy_birthplace}</h4>
				</dt>
				
				<dt class="faq-list_h">
				<h4 class="marker">已修学分</h4>
				<h4><span style="color:white">hahahahaha</span>${student.luoyy_scredit}</h4>
				</dt>
				
				<dt class="faq-list_h">
				<h4 class="marker">专业编号</h4>
				<h4><span style="color:white">hahahahaha</span>${student.luoyy_mno}</h4>
				</dt>
				
				<dt class="faq-list_h">
				<h4 class="marker">班级编号</h4>
				<h4><span style="color:white">hahahahaha</span>${student.luoyy_classno}</h4>
				</dt>
          </dl>
	   </div>
	</div>
