	   	    ...
	   	    <div class="col-md-6">
                <div class="service_1">
                    ...
                    <div class="service_1-right">
                       <h5><a href="${pageContext.request.contextPath}/queryTeacher.do?luoyy_tno=${luoyy_tno}">查询个人基本信息</a></h5>
                        <p>教师编号  姓名  性别  出生年月  职称  联系电话</p>
                    </div>
                </div>
            </div>
             <div class="col-md-6">
                <div class="service_1">
                    ...
                    <div class="service_1-right">
                       ...
                       <h5><a href="${pageContext.request.contextPath}/queryTeach.do?luoyy_tno=${luoyy_tno}">任课查询</a></h5>
                        <p></p>
                    </div>
                </div>
            </div>
	   ...
	   <div class="service_box1">
	   	    <div class="col-md-6">
                <div class="service_1">
                    ...
                    <div class="service_1-right">
                       <h5><a href="${pageContext.request.contextPath}/teacher/addReport.jsp?luoyy_tno=${luoyy_tno}">导入成绩</a></h5>
                        <p></p>
                    </div>
                </div>
            </div>
             <div class="col-md-6">
                <div class="service_1">
                    ...
                    <div class="service_1-right">
                       <h5><a href="${pageContext.request.contextPath}/queryTeach.do?luoyy_tno=${luoyy_tno}">查看学生成绩状况</a></h5>
                        <p></p>
                    </div>
                </div>
            </div>
